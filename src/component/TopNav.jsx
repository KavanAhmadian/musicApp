        ...
        <>
            ...
            <div className="flex items-center justify-between p-4">
                <button onClick={toggleSidebar}>
                    <Icon icon={`solar:hamburger-menu-outline`} className="w-8 h-8 cursor-pointer  text-white"/>
                </button>
            ...
            {/* Sidebar */}
            <div
                className={` fixed top-0 right-0 h-full w-75 bg-[#212121] text-white transform transition-transform duration-300 z-50 ${
                        ...
                        return (
                            <Link
                                ...
                                className={`flex items-center gap-2 pb-2 ${
                                    index === 0 || index === 4 ? "border-b border-white" : ""
                                }`}
                            >
            ...
            {isSidebarOpen && (
                <div
                    ...
                    className="fixed inset-0 z-40 bg-black/50 dark:bg-gray-500/50"
                ></div>
            )}
        </>
    );
