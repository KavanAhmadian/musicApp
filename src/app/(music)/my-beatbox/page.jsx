    ...
    return (
        <div>
            <div className={`w-full bg-linear-to-b from-black to-[#4e4e4e] rounded-b-2xl py-8 flex flex-col items-center justify-center`}>
                <span className={`text-white text-[18px] mb-2`}>هادی - 09123456789</span>
                <span className={`text-[#FFEB3B] text-[21px]`}> تعداد امتیاز : 18 </span>
            ...
            <div className={`flex flex-col items-center justify-center gap-2 mx-auto w-9/10 mt-8`}>
